        ...
        <div className="categories-page">
            <header className="new-hero d-flex align-items-center" style={{ padding: '150px 0 100px' }}>
                <div className="container">
                    ...
                    <p className="lead text-white-50">কুরআন, হাদিস এবং ইসলামের বিভিন্ন বিষয়ের ওপর গভীর আলোচনা</p>
                </div>
            </header>
            ...
            <section className="py-5 bg-light">
                <div className="container">
                    <h2 className="display-4 fw-bold display-luxury mb-5 text-center">সবগুলো প্রবন্ধ</h2>
                    <div className="row g-4">
                        {posts.map((post, i) => (
